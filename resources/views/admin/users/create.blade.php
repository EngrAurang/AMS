    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_leaves') ? 'is-invalid' : '' }}" type="number" name="total_leaves" id="total_leaves" value="{{ old('total_leaves', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('leaves_taken') ? 'is-invalid' : '' }}" type="number" name="leaves_taken" id="leaves_taken" value="{{ old('leaves_taken', '0') }}" step="0.01">
